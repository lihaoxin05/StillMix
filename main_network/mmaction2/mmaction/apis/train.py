...
from ..core import (DistEvalHook, EvalHook, OmniSourceDistSamplerSeedHook,
                    OmniSourceRunner, EpochShowRunner)
...
def train_model(model,
    ...
    cfg.epoch_runner = cfg.get('epoch_runner', False)
    if cfg.omnisource:
        Runner = OmniSourceRunner
    elif cfg.epoch_runner:
        Runner = EpochShowRunner
    else:
    ...
    if cfg.epoch_runner:
        runner_kwargs.update(epoch_runner=True)
