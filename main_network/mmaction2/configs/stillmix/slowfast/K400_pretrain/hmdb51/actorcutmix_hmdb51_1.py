...
model = dict(
    ...
    train_cfg=dict(blending=dict(type='ActorCutmixBlending', num_classes=51, prob_aug=0.5)),
...
work_dir = './work_dirs/stillmix_v2/slowfast/K400_pretrain/hmdb51/actorcutmix/1'
