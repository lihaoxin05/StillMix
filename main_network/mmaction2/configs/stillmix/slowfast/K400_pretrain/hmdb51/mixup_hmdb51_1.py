...
model = dict(
    ...
    train_cfg=dict(blending=dict(type='MixupBlending_fixbs', num_classes=51, alpha=.2, prob_aug=0.25)),
...
work_dir = './work_dirs/stillmix_v2/slowfast/K400_pretrain/hmdb51/mixup/1'
