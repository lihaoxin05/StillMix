...
model = dict(
    ...
    train_cfg=dict(blending=dict(type='FameBlending', num_classes=51, frame_mean=[123.675, 116.28, 103.53], frame_std=[58.395, 57.12, 57.375], prob_aug=0.25)),
...
work_dir = './work_dirs/stillmix_v2/slowfast/K400_pretrain/hmdb51/fame/1'
