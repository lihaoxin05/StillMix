...
det_file = '/export/xxx/xxx/datasets/UCF101/actor_detections.npy'
...
model = dict(
    ...
    train_cfg=dict(blending=dict(type='ActorCutmixBlending', num_classes=101, prob_aug=0.25)),
...
work_dir = './work_dirs/stillmix_v2/slowfast/IN_pretrain/ucf101/actorcutmix/1'
