...
model = dict(
    ...
    train_cfg=dict(blending=dict(type='CutmixBlending_fixbs', num_classes=51, alpha=1.0, prob_aug=0.5)),
...
work_dir = './work_dirs/stillmix_v2/slowfast/IN_pretrain/hmdb51/cutmix/1'
