...
model = dict(
    ...
    train_cfg=dict(blending=dict(type='CutmixBlending_fixbs', num_classes=400, alpha=1.0, prob_aug=1.0)),
...
work_dir = './work_dirs/stillmix_v2/slowfast/IN_pretrain/kinetics400/cutmix/1'
