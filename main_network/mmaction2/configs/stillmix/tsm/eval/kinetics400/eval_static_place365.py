...
data_root = '/export/home/xxx/xxx/datasets/Kinetics_400/generated/v2/replacebackground_with_segmentation_and_saliency_for_test_place365'
...
ann_file_test = '/export/home/xxx/xxx/work/dataset_config/Kinetics_400/lists_generated/v2/replacebackground_with_segmentation_and_saliency_for_test_place365/val.txt'
img_norm_cfg = dict(
...
model = dict(
    ...
    test_cfg=dict(blending=dict(type='TemporalSelect', num_classes=400)),)
