...
data_root_test = '/export/home/xxx/xxx/datasets/UCF101-24/generated/v1/replacebackground_with_box_for_UCF101_test_place365/generated_videos'
...
ann_file_test = f'/export/home/xxx/xxx/work/dataset_config/UCF101-24/lists_generated/v1/replacebackground_with_box_for_UCF101_test_place365/101classes/testlist0{split}.txt'
...
model = dict(
    ...
    test_cfg=dict(blending=dict(type='TemporalSelect', num_classes=101)),)
...
work_dir = './work_dirs/stillmix_v2/tsm/IN_pretrain/ucf101/eval'
