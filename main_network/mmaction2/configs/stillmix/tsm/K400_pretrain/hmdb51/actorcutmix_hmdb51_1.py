...
det_file = '/export/home/xxx/xxx/datasets/HMDB51/actor_detections.npy'
...
model = dict(
    ...
    train_cfg=dict(_delete_=True, 
        blending=dict(type='ActorCutmixBlending', num_classes=51, prob_aug=0.25)),)
...
work_dir = './work_dirs/stillmix_v2/tsm/K400_pretrain/hmdb51/actorcutmix/1'
