...
__all__ = ['BaseMiniBatchBlending', 'MixupBlending', 'MixupBlending_fixbs', 'CutmixBlending', 'CutmixBlending_fixbs', 'LabelSmoothing', 'ActorCutmixBlending', 'BEIntraBlending', 'FameBlending', 'StillMixRandomBlending', 'StillMixFrameBankBlending', 'TemporalSelect']
...
class MixupBlending_fixbs(BaseMiniBatchBlending):
    ...
    def __init__(self, num_classes, alpha=.2, smoothing=0., prob_aug=1.0):
        super().__init__(num_classes=num_classes, smoothing=smoothing)
        self.beta = Beta(alpha, alpha)
