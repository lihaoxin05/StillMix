...
model=dict(backbone=dict(patch_size=(2,4,4), drop_path_rate=0.1), 
        ...
        train_cfg=dict(blending=dict(type='FameBlending', num_classes=400, frame_mean=[123.675, 116.28, 103.53], frame_std=[58.395, 57.12, 57.375], prob_aug=0.25)),)
...
work_dir = './work_dirs/stillmix_v2/Swin-T/IN_pretrain/kinetics400/fame/1'
