...
model=dict(backbone=dict(patch_size=(2,4,4), drop_path_rate=0.1), 
        ...
        train_cfg=dict(blending=dict(type='CutmixBlending_fixbs', num_classes=101, alpha=1.0, prob_aug=0.75)),)
...
work_dir = './work_dirs/stillmix_v2/Swin-T/IN_pretrain/ucf101/cutmix/1'
