...
data_root = '/home/xxx/xxx/mount_datasets/Kinetics_400/generated/v1/replacebackground_with_segmentation_and_saliency_for_test_place365'
...
ann_file_test = '/home/xxx/xxx/work/dataset_config/Kinetics_400/lists_generated/v1/replacebackground_with_segmentation_and_saliency_for_test_place365/val.txt'
...
model=dict(backbone=dict(patch_size=(2,4,4), drop_path_rate=0.1), 
        ...
        test_cfg=dict(max_testing_views=4, blending=dict(type='TemporalSelect', num_classes=400)))
...
work_dir = './work_dirs/stillmix_v2/Swin-T/IN_pretrain/kinetics400/eval'
