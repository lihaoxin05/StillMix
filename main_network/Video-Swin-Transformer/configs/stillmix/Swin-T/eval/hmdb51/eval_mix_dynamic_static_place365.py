...
data_root = '/media/storage3/xxx/xxx/datasets/JHMDB/generated/v2/mix_dynamic_static_same_bg_for_HMDB51_test_stripe/generated_videos'
...
ann_file_test = f'/home/xxx/xxx/work/dataset_config/JHMDB/lists_generated/v2/mix_dynamic_static_same_bg_for_HMDB51_test_stripe/51classes/dynamic_testlist0{split}.txt'
img_norm_cfg = dict(
...
test_pipeline = [
    dict(
        ...
        test_mode=True),
    dict(type='RawFrameDecode'),
    # dict(type='Resize', scale=(224, 448), keep_ratio=False),
    dict(type='Resize', scale=(224, 224), keep_ratio=False),
