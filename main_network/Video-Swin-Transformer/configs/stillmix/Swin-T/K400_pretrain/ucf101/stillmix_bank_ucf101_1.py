...
model=dict(backbone=dict(patch_size=(2,4,4), drop_path_rate=0.1), 
        ...
        train_cfg=dict(blending=dict(type='StillMixFrameBankBlending', 
            num_classes=101,
...
# optimizer
optimizer = dict(type='AdamW', lr=3.75e-4, betas=(0.9, 0.999), weight_decay=0.01,
...
work_dir = './work_dirs/stillmix_v2/Swin-T/K400_pretrain/ucf101/stillmix_bank/1'
