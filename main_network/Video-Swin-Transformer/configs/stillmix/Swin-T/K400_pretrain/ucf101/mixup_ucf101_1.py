...
model=dict(backbone=dict(patch_size=(2,4,4), drop_path_rate=0.1), 
        ...
        train_cfg=dict(blending=dict(type='MixupBlending_fixbs', num_classes=101, alpha=.2, prob_aug=0.5)),)
...
work_dir = './work_dirs/stillmix_v2/Swin-T/K400_pretrain/ucf101/mixup/1'
