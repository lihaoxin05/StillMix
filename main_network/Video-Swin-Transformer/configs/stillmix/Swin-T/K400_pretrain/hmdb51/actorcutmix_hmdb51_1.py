...
model=dict(backbone=dict(patch_size=(2,4,4), drop_path_rate=0.1), 
        ...
        train_cfg=dict(blending=dict(type='ActorCutmixBlending', num_classes=51, prob_aug=0.25)),)
...
work_dir = './work_dirs/stillmix_v2/Swin-T/K400_pretrain/hmdb51/actorcutmix/1'
